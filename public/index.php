    ...
    <main>
        ...
        <section id="home" class="container">
            <div class="homeLeft elementsScroll">
                ...
                <p>Autodidacte passionné par l'univers de la programmation, je suis déterminé à
                    me réorienter vers le métier de développeur web. 
                    L'esprit d'équipe,
                    l'investissement dans le travail, et le sérieux sont les qualités qui m'animent
